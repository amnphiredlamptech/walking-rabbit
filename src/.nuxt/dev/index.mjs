...
const getClientManifest = () => import('/Users/man/Desktop/workspace/microservice/vue-hello-world-simple-nuxt/src/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('/Users/man/Desktop/workspace/microservice/vue-hello-world-simple-nuxt/src/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
