import { getCurrentInstance, ref, useSSRContext, defineComponent, h, inject, computed, unref, Suspense, Transition, provide, reactive, resolveComponent, shallowRef, createApp, toRef, isRef, defineAsyncComponent, onErrorCaptured, nextTick, watchEffect, withCtx, createVNode } from 'vue';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(_attrs)}>Counter ${ssrInterpolate(x.value)}</button>`);
    };
  }
};
...
const _routes = [
  {
    name: "index",
    path: "/",
    file: "/Users/man/Desktop/workspace/microservice/vue-hello-world-simple-nuxt/src/runtime/pages/index.vue",
    children: [],
    meta,
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index.e27385d8.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.ee98bd93.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _sfc_main$2 as _, _export_sfc as a, useHead as b, __nuxt_component_0$1 as c, entry$1 as default, useNuxtApp as u };
